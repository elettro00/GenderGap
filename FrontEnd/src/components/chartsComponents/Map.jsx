...
const Map = () => {
  ...
  const onEachFeature = (feature, layer) => {
    const regionName =
      feature.properties.name || feature.properties.NAME || "Sconosciuta";
    ...
    <div>
      <div className="map-main-container">
        <div className="filter-map-container">
          <Dropdown
           desc={'map-chart'}
            options={options}
            df={"ALL"}
            title={"Seleziona l'anno di visualizzazione:"}
            ...
            <div className="map-content">
              <div className="map-wrapper">
                {italiaGeojson ? (
                  ...
                  >
                    <GeoJSON
                      key={"G" + selectedRegion?.name + selectedYear}
                      ref={setGeoJsonRef}
                      data={italiaGeojson}
                      style={style}
        ...
        <div className="map-description">
          <p>
            La mappa mostra come in tutte le regioni italiane il{" "}
            <b>Gender Gap</b> nel settore ICT si amplifichi lungo la carriera
            accademica: le donne sono già minoranza tra gli immatricolati e
            diventano ancora più sottorappresentate tra laureati e soprattutto
            tra professori e ricercatori, segno di barriere strutturali e
            culturali che ostacolano la progressione femminile nel digitale
          </p>
        </div>
      </div>
    </div>
